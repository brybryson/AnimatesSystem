...
function showEditModal(itemId) {
    ...
    // For stock_controller, disable certain fields
    ...
    if (role === 'stock_controller') {
        ...
        document.getElementById('itemUnitPrice').disabled = true;
        document.getElementById('itemVendor').disabled = true;
        document.getElementById('itemMinStock').disabled = true;
        document.getElementById('itemCriticalStock').disabled = true;
        ...
        document.getElementById('itemVendor').disabled = false;
        document.getElementById('itemMinStock').disabled = false;
        document.getElementById('itemCriticalStock').disabled = false;
