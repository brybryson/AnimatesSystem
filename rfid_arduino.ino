...
#define SERVER_URL "http://192.168.1.43/animates/api/rfid_endpoint.php" 
...
DeviceConfig config = {
    ...
    .disableTime = 5000,
    .cardTimeout = 2000,
    .serverUrl = "http://192.168.1.43/animates/api/rfid_endpoint.php"
};
...
void loadConfig() {
  ...
  config.serverUrl = preferences.getString("serverUrl", "http://192.168.1.43/animates/api/rfid_endpoint.php");
